...
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports {CLK}]; # 100MHz
#create_clock -add -name sys_clk_pin -period 25.00 [get_ports {CLK}]; # 40MHz
#create_clock -add -name sys_clk_pin -period 40.00 -waveform {0 20} [get_ports {CLK}]; # 25MHz
# period 25 should give a 40Mhz Clock
...
#set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { Sanity }]; #IO_L18P_T2_A24_15 Sch=led[0]
...
#set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { RESET_CNT }]; #IO_L3P_T0_DQS_AD1P_15 Sch=cpu_resetn

set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { RESET_CNT }]; #IO_L9P_T1_DQS_14 Sch=btnc
